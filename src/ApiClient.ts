...
export interface ConfigurationParameters {
    ...
    credentials?: RequestCredentials_; //value for the credentials param we want to use on each request
}
...
export class Configuration {
    ...
    set config(configuration: Configuration) {
        ...
        this.configuration.middleware = configuration.middleware ?? [];
    }
    ...
    get credentials(): RequestCredentials_ | undefined {
...
export class BaseAPI {
    ...
    private clone<T extends BaseAPI>(this: T): T {
        ...
        next.middleware = Array.isArray(this.middleware)
